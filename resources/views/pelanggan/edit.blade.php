    ...
    <div class="card">
        ...
        <form class="forms-sample" method="post" action="{{'/pelanggan/' . $data->id}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_pelanggan" name="nama_pelanggan" placeholder="Masukkan nama pelanggan" value="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon" placeholder="Masukkan nomor telepon" value="">
            </div>
